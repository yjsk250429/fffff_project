        ...
        <JoinInfoStyle>
            <div className="inner">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    ...
                                    />
                                    <button className="chk" onClick={checkEmail}>중복확인</button>
                                    {emailMsg && (
                    <div
                      className={`msg ${emailStatus === 'ok' ? 'ok' : emailStatus === 'dup' ? 'error' : 'neutral'}`}
                      style={{
                        marginTop: 6,
                        fontSize: 12,
                        color: emailStatus === 'ok' ? '#2e7d32' : emailStatus === 'dup' ? '#d32f2f' : '#6b7280',
                      }}
                    >
                      {emailMsg}
                    </div>
                            ...
                            <td>
                                <p>
                                    <input
                                        ...
                                        onChange={changeInput}
                                    />
                                    <i onClick={() => setShowPw(!showPw)}>{showPw ? <IoMdEyeOff />:<IoMdEye />
                                    }</i>
                                </p>
                                <p>
                                    <span>
                ...
                <BtnStyle>
                    ...
                    <p>
                    <Button text='다음' width="354px" height="50px" bgColor="#000" textColor="#fff" type="submit"/>
