...
const Reivew = forwardRef((props, ref) => {
    ...
    const avgRate =
        currentProductReviews.length > 0
            ...
            : 0;
    const stars = '★'.repeat(Math.round(avgRate)) + '☆'.repeat(5 - Math.round(avgRate));
            ...
            <div className="inner">
                ...
                <div className="review-wrap">
                    <div className="controls">
                        <p className="totalRate">
                            <span>{stars}</span>
                            <span>{avgRate}</span> / 5.0
                        </p>
                        <p className="sorts">
                            <span
                        ...
                        <p className="filterBtns">
                            <Button
                                ...
                                bgColor={filter === 'all' ? '#000' : ''}
                                textColor={filter === 'all' ? '#fff' : ''}
                            />
                            <Button
                                text="포토리뷰"
                                width="130px"
                                ...
                                bgColor={filter === 'photo' ? '#000' : ''}
                                textColor={filter === 'photo' ? '#fff' : ''}
                            />
                        </p>
                    </div>
                    ...
                    <p className="write">
                        <Button text="리뷰 작성" bgColor="#000" textColor="#fff" />
                    </p>
                </div>
            </div>
        </ReviewStyle>
