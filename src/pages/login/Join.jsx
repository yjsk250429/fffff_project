        ...
        <JoinStyle>
            <div className="inner">
                ...
                <p className='required'>
                    ...
                    >
                        ...
                        />
                        서비스이용약관 관련 동의 (필수)
                        <i onClick={() => setOpenRequired(v => !v)}><TfiAngleDown /></i>
                    </label>
                    {openRequired && (
                        <span>
                        개인정보 수집 및 이용동의
                ...
                <p className='optional'>
                    ...
                    >
                        ...
                        <i  onClick={() => setOpenOptional(v => !v)}><TfiAngleDown /></i>
                    </label>
            ...
            <>
              ...
              <label className="choice" htmlFor="email">
                ...
                <p className="btns">
                    <Button text='취소' width="354px" height="50px" borderColor="var(--foundation-white-dark)" onClick={() => navigate('/login')}/>
                    <Button text='다음' width="354px" height="50px" bgColor="#000" textColor="#fff" borderColor="var(--foundation-white-dark)" onClick={Next}/>
                </p>
            </div>
        </JoinStyle>
    );
